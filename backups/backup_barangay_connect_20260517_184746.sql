...
INSERT INTO `complaint` (`ComplaintID`, `RequestID`, `RespondentName`, `RespondentContact`, `RespondentRelationship`, `RespondentResidentID`, `IncidentDate`, `IncidentLocation`, `Description`, `Witnesses`, `ReliefSought`, `MediationDate`, `ActionsTaken`) VALUES ('2', '20', 'Karen Sita', '12345678', 'Stranger', NULL, '2026-05-15', 'KALIBUNAN', 'MURDER', '', '', NULL, NULL);
...
INSERT INTO `facility` (`FacilityID`, `FacilityName`, `Capacity`, `ReservationFee`, `Description`, `Status`, `CreatedAt`) VALUES ('2', 'Basketball Court', '200', '300.00', 'Outdoor basketball court for sports events and community activities.', 'Inactive', '2026-04-19 15:39:22');
...
INSERT INTO `servicerequest` (`RequestID`, `ReferenceNo`, `ResidentID`, `RequestType`, `Purpose`, `Status`, `Remarks`, `ProcessedBy`, `ProcessedAt`, `ReleasedBy`, `ReleasedAt`, `CancelledBy`, `CancelledAt`, `CancellationReason`, `CreatedBy`, `CreatedAt`, `UpdatedAt`, `SecretaryNote`, `PreparedBy`, `PreparedAt`) VALUES ('20', 'BRGY-20260517-00006', '5', 'Complaint', 'MURDER', 'Pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '11', '2026-05-18 00:14:13', '2026-05-18 00:14:13', NULL, NULL, NULL);
