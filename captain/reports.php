    ...
    <main class="main-content">
        ...
        <div class="page-body">
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        <?php if (empty($monthlySummary)): ?>
                            <tr>
                                <td colspan="7" class="empty-row">No requests this month.</td>
                            </tr>
                        <?php else: ?>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        <?php if (empty($weeklyPending)): ?>
                            <tr>
                                <td colspan="5" class="empty-row">No requests are past SLA.</td>
                            </tr>
                        <?php else: ?>
                    ...
                    <table class="data-table compact-table">
                        ...
                        <tbody>
                            <?php if (empty($complaintSummary)): ?>
                                <tr>
                                    <td colspan="3" class="empty-row">No complaints found.</td>
                                </tr>
                    ...
                    <table class="data-table compact-table">
                        ...
                        <tbody>
                            <?php if (empty($facilityUtilization)): ?>
                                <tr>
                                    <td colspan="3" class="empty-row">No facility data found.</td>
                                </tr>
            ...
            <div class="report-grid mt-4">
                <div class="card">
                    <div class="card-header">
                        <h3>Resident Demographics by Sex</h3>
                    </div>
                    <table class="data-table compact-table">
                        <thead>
                            <tr>
                    ...
                    <table class="data-table compact-table">
                        ...
                        <tbody>
                            <?php if (empty($staffPerformance)): ?>
                                <tr>
                                    <td colspan="4" class="empty-row">No staff activity found.</td>
                                </tr>
