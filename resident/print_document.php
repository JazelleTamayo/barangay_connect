<?php
// Barangay Connect – Print Document (Resident)
// resident/print_document.php
// Allows a resident to view and print their own Released Clearance or Indigency certificate.
...
// Load the service request — must belong to this resident and be Released
$stmt = $pdo->prepare("
    SELECT sr.*,
...
if (!$req) {
    ...
    die('Document not found, not yet released, or you do not have permission to view it.');
}
